...
const ProjectCard = ({
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className="relative w-full h-[230px] m-3 card-img_hover">
          <img
            src={image}
            alt={name}
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Following Projects Showcased my skills and experience through
          real-world examples of my work. Each project is briefly described with
          links to code repositories. I treflects my ability to solve complex
